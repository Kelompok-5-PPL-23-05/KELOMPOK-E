...
class NilaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->nilai as $entry) {
            ...
            // Hitung nilai akhir berbobot dan simpan ke rapor jika UTS, UAS, dan Tugas sudah lengkap.
            $averager->computeForStudentMapel($siswa->id_siswa, $request->mapel_id);
        }
    ...
    public function update(Request $request, Nilai $nilai)
    {
        ...
        app(NilaiAverager::class)->computeForStudentMapel(
            $nilai->Siswaid_siswa,
            $nilai->Mata_Pelajaranid_mapel
        );
