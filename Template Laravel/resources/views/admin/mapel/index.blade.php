...
<div class="modal-overlay" id="modal-upload">
    <div class="modal">
        <div class="modal-title">Upload Data Mata Pelajaran</div>
        <form method="POST" action="{{ route('admin.mapel.import') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <small>Pastikan file CSV memiliki header dan data berada di kolom pertama (Nama Mata Pelajaran).</small>
            </div>
            <div class="modal-actions">
