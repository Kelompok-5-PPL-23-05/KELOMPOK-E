...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .alert { display: flex; align-items: flex-start; gap: 12px; padding: 14px 18px; border-radius: 10px; margin-bottom: 20px; font-size: 14px; font-weight: 500; animation: slideDown 0.3s ease; }
        ...
        .card-title { font-size: 17px; font-weight: 700; color: #1a1a2e; margin-bottom: 20px; display: flex; align-items: center; gap: 10px; }
        ...
        .filter-select { appearance: none; background: #f7fafc url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23000' stroke-width='2'%3E%3Cpolyline points='6 9 12 15 18 9'/%3E%3C/svg%3E") no-repeat right 12px center; background-size: 16px; border: 1.5px solid #cbd5e0; border-radius: 8px; padding: 10px 40px 10px 14px; font-size: 14px; font-family: 'Poppins', sans-serif; color: #1a1a2e; outline: none; cursor: pointer; transition: border-color 0.2s; }
        ...
        .no-data { text-align: center; padding: 48px; color: #a0aec0; font-size: 14px; }
        .no-data-icon { font-size: 40px; margin-bottom: 12px; }
        .guru-info-row { display: flex; align-items: center; gap: 16px; }
        .guru-avatar { width: 48px; height: 48px; background: linear-gradient(135deg, #4a6fa5, #6c8bbf); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 20px; color: #fff; font-weight: 700; }
        ...
        .mapel-tag { background: #ebf4ff; color: #2c5282; border-radius: 6px; padding: 4px 12px; font-size: 12px; font-weight: 600; }
        .mapel-tag-empty { color: #a0aec0; font-size: 13px; font-style: italic; }
        .action-link { color: #4a6fa5; text-decoration: none; font-weight: 600; font-size: 13px; padding: 5px 12px; border-radius: 6px; background: #ebf4ff; transition: all 0.2s; }
...
<body>
    ...
    <aside class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="{{ route('input-nilai') }}" class="nav-item-single">Masukkan Nilai</a>
